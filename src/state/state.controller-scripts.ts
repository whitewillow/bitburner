...
export const DEFAULT_CONTROLLER_SCRIPTS: ControllerScript[] = [
  { id: 'queue', script: 'services/queue.service.js', name: 'Queue Service', state: 'SYSTEM', warnIfNotRunning: true },
  { id: 'penetrator', script: 'services/penetrator.service.js', name: 'Penetrator Service', state: 'SYSTEM', warnIfNotRunning: true },
  ...
  { id: 'proto', script: 'services/proto.service.js', name: 'Proto Service', state: 'START', warnIfNotRunning: true },
];
